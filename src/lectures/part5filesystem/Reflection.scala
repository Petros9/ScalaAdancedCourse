...
object Reflection extends App {
  ...
  // reflection, call classes at runtime

  case class Person(name: String) {
    def sayMyName(): Unit = println(s"Hi $name")
  }
  ...
  // 2 - create a class object - class description
  ...
  // I have an instance
  val p = Person("Mary")
  // method computed from somewhere else
  ...
  // pp: #1: differentiate types as runtime

  val numbers = List(1, 2, 3)
  numbers match {
    case listOfStrings: List[String] => println("strings")
    case listOfNumbers: List[Int] => println("ints")
  }
  ...
  // 4 - reflect the method symbol = can Do things
